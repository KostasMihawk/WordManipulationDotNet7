...
namespace WordManipulationDotNet7.Models
{
    public class DropDownGenerator
    {
        ...
        public List<Attorney> GetNotaries()
        {
            ...
            {
                Id = id++,
                Description = "του Όθωνα Κωνσταντίνου Ρούσσου, συμβολαιογράφου Πατρών, μέλους της αστικής επαγγελματικής εταιρείας Συμβολαιογράφων με την επωνυμία «ΕΤΑΙΡΕΙΑ ΣΥΜΒΟΛΑΙΟΓΡΑΦΩΝ ΟΘΩΝ Κ. ΡΟΥΣΣΟΣ – ΕΥΓΕΝΙΑ Π. ΣΤΑΥΡΟΠΟΥΛΟΥ» που εδρεύει στην Πάτρα, οδός Παντανάσσης αριθμός 9, με ΑΦΜ 996502166, ως επί του πλειστηριασμού υπαλλήλου,",
                City = "Πάτρα",
                Pronoun = "του",
                Name = "Όθωνας Ρούσσος",
                GiaSunexisi = "του συμβολαιογράφου Πατρών Όθωνα Κωνσταντίνου Ρούσσου,μέλους της αστικής επαγγελματικής εταιρείας Συμβολαιογράφων με την επωνυμία «ΕΤΑΙΡΕΙΑ ΣΥΜΒΟΛΑΙΟΓΡΑΦΩΝ ΟΘΩΝ Κ. ΡΟΥΣΣΟΣ – ΕΥΓΕΝΙΑ Π. ΣΤΑΥΡΟΠΟΥΛΟΥ» που εδρεύει στην Πάτρα, οδός Παντανάσσης αριθμός 9, με ΑΦΜ 996502166, ως επί του πλειστηριασμού υπαλλήλου,"
            });
            return list;
        }
        ...
        public List<EkthesiEpidoshsModel> GetZipFiles()
        {
            ...
            list.Add(new EkthesiEpidoshsModel
            {
                ...
                HasKleisimo = Kleisimo.exei,
                Signature = Signature.paralavon,
                Kleisimo = "Αφού δεν βρήκα τον νόμιμο εκπρόσωπο της άνω Εταιρίας στην έδρα της, στην οδό Πανεπιστημίου αρ.41, ούτε Διευθυντή ή συνεργάτη, αλλά τ… εξουσιοδοτημέν… για την παραλαβή υπάλληλο αυτής …………………….……………, όπως μου δήλωσε, επέδωσα σ΄ αυτ…. το άνω δικόγραφο."
            });
            list.Add(new EkthesiEpidoshsModel
            {
                Location = "Στο Αμαρούσιο Αττικής",
            ...
            list.Add(new EkthesiEpidoshsModel
            {
                Location = "Στη Καλλιθέα Αττικής",
                Name = "EOS MATRIX",
                Perigrafh = "προς την ανώνυμη τραπεζική εταιρεία υπό ειδική εκκαθάριση με την επωνυμία «EOS MATRIX GREECE ΑΝΩΝΥΜΗ ΕΤΑΙΡΕΙΑ ΔΙΑΧΕΙΡΙΣΗΣ ΑΠΑΙΤΗΣΕΩΝ ΑΠΟ ΔΑΝΕΙΑ ΚΑΙ ΠΙΣΤΩΣΕΙΣ» και τον διακριτικό τίτλο «EOS MATRIX GREECE ΕΤΑΙΡΕΙΑ ΔΙΑΧΕΙΡΙΣΗΣ ΑΠΑΙΤΗΣΕΩΝ Μ.Α.Ε.» η οποία εδρεύει στην Καλλιθέα Αττικής επί της Λεωφ. Συγγρού αρ. 328-330 και εκπροσωπείται νόμιμα, η οποία ενεργεί κατ’ εντολή και για λογαριασμό και ούσα νόμιμη αντιπρόσωπος της εταιρείας με την επωνυμία «EOS FINANCE GmbH» η οποία εδρεύει στο Αμβούργο Γερμανίας, οδός Steindamm αρ. 71 και εκπροσωπείται νόμιμα, ως καθολικής διαδόχου της εταιρείας με την επωνυμία “BARCLAYS BANK PLC” η οποία εδρεύει στο Λονδίνο οδός 1 Churchill Place και εκπροσωπείται νόμιμα",
                Praxh = true,
                FusikoProswpo = false,
                HasKleisimo = Kleisimo.exei,
                Signature = Signature.paralavon,
                Kleisimo = "Αφού δεν βρήκα τον νόμιμο εκπρόσωπο της άνω Εταιρίας στην έδρα της, στην Λεωφ. Συγγρού 328-330, ούτε Διευθυντή ή συνεργάτη, αλλά τ… εξουσιοδοτημέν… για την παραλαβή υπάλληλο αυτής …………………….……………, όπως μου δήλωσε, επέδωσα σ΄ αυτ…. το άνω δικόγραφο.",
                ZoneB = false
            });
            list.Add(new EkthesiEpidoshsModel
            {
