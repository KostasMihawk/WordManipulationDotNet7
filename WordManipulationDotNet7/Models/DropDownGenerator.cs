...
namespace WordManipulationDotNet7.Models
{
    public class DropDownGenerator
    {
        ...
        public List<Attorney> GetNotaries()
        {
            ...
            {
                Id = id++,
                Description = "ης Βαρβάρας Α. Σγούρα, μέλους της Εταιρείας Συμβολαιογράφων με την επωνυμία «ΕΤΑΙΡΕΙΑ ΣΥΜΒΟΛΑΙΟΓΡΑΦΩΝ ΒΑΡΒΑΡΑ Α. ΣΓΟΥΡΑ-ΑΙΚΑΤΕΡΙΝΗ Κ. ΟΙΚΟΝΟΜΟΥ-ΚΩΝΣΤΑΝΤΙΝΟΣ Ε.ΣΤΕΡΓΙΟΥ» που εδρεύει στην Αθήνα, οδός Καποδιστρίου αριθμός 18, με ΑΦΜ 996561989, ΚΕΦΟΔΕ Αττικής",
                City = "Αθήνας",
                Pronoun = "της",
                Name = "Βαρβάρα Σγούρα",
                GiaSunexisi = "ης Βαρβάρας Α. Σγούρα, μέλους της Εταιρείας Συμβολαιογράφων με την επωνυμία «ΕΤΑΙΡΕΙΑ ΣΥΜΒΟΛΑΙΟΓΡΑΦΩΝ ΒΑΡΒΑΡΑ Α. ΣΓΟΥΡΑ-ΑΙΚΑΤΕΡΙΝΗ Κ. ΟΙΚΟΝΟΜΟΥ-ΚΩΝΣΤΑΝΤΙΝΟΣ Ε.ΣΤΕΡΓΙΟΥ» που εδρεύει στην Αθήνα, οδός Καποδιστρίου αριθμός 18, με ΑΦΜ 996561989, ΚΕΦΟΔΕ Αττικής"
            });
            list.Add(new Attorney
            {
                Id = id++,
