...
namespace WordManipulationDotNet7.Models
{
    public class DropDownGenerator
    {
        ...
        public List<Attorney> GetNotaries()
        {
            ...
            {
                Id = id++,
                Description = "του Όθωνα Κωνσταντίνου Ρούσσου, συμβολαιογράφου Πατρών, με έδρα τη Πάτρα Αχαΐας, οδός Παντανάσσης αριθμός 9 ",
                City = "Πάτρα",
                Pronoun = "του",
                Name = "Όθωνας Ρούσσος",
                GiaSunexisi = "του συμβολαιογράφου Πατρών Όθωνα Κωνσταντίνου Ρούσσου με έδρα την Πάτρα "
            });
            return list;
        }
